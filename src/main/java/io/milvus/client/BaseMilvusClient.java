...
public interface BaseMilvusClient {

  String clientVersion = new Supplier<String>() {
    @Override
    public String get() {
      Properties properties = new Properties();
      try (InputStream inputStream = MilvusClient.class.getClassLoader()
  ...
  static BaseMilvusClient create(ConnectParam connectParam) {
   ...
   */
  BaseMilvusClient withTimeout(long timeout, TimeUnit timeoutUnit);
   ...
   * @return collection stats string in JSON
   */
   ...
   * @return <code>VectorEntities</code>
   */
   ...
   *
   * @param collectionNames a <code>List</code> of collections to flush
   * @return a <code>ListenableFuture</code>
   * @see ListenableFuture
   */
